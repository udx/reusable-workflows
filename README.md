...
| **[js-ops](.github/workflows/js-ops.yml)**                       | Build, validate, and release immutable Next.js standalone bundles to GitHub Releases with metadata                  | [📖 Docs](docs/workflows/js-ops.md)            | [📋 Example](examples/js-ops.yml)            |
